...
class TaskController {
  ...
  async createTask(req, res, next) {
    ...
    try {
      ...
      new HttpResponse('Successfully created new task', true, task).created(res)
    } catch (err) {
      console.error(err)
      next(err)
    }
  ...
  async editTask(req, res, next) {
    ...
    try {
      ...
      const updatedTask = await this.taskService.editTask(task, req.body)
      new HttpResponse('Successfully updated task', true, updatedTask).ok(res)
    } catch (err) {
      console.error(err)
      next(err)
    }
  ...
  async addCategoriesToTask(req, res, next) {
    ...
    try {
      ...
      new HttpResponse('Successfully attached categories to task', true).ok(res)
    } catch (err) {
      console.error(err)
      next(err)
    }
